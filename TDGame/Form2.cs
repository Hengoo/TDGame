...
namespace TDGame
{
    ...
    public partial class Form2 : Form
    {
        ...
        /// <summary>
        /// Gibt die, seit dem des erschaffens des Servers vergangene Zeit an.
        /// </summary>
        public int zeit;
        /// <summary>
        ...
        /// <summary>
        /// Schreibt etwas auf das Label der Form
        /// </summary>
        private void AccessToTB()
        {
            label1.Text = "Zeit" + zeit;
        }

        /// <summary>
        /// Beschreibt das Label das den Port angibt
        /// </summary>
        public void label2beschreiben()
        {
            this.Invoke(new MethodInvoker(AccessToTB2));
        }

        /// <summary>
        /// Schreibt etwas auf das Label der Form
        /// </summary>
        private void AccessToTB2()
        {
            label2.Text = "Port: " + server.udpm.port;
        }
                ...
                if (sw.ElapsedMilliseconds > cnt)
                {
                    ...
                    if (server.voll)
                    {
                        ...
                        if (zaehler >= 60)
                        {
                            ...
                            try
                            {
                                this.Invoke(new MethodInvoker(AccessToTB));
                            }
                            catch (Exception)
                            {
                                throw;
