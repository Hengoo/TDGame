...
namespace TDGame
{
    ...
    public static class Global
    {
        ...
        public static void entschluesseln(string befehl, Kommunikation.Server server)
        {
            ...
            {
                case Befehlstyp.verbessern:
                    if (server.voll && server.con_list[0].spieler == (Spieler)befehl[4] && server.con_list[0].geld > 0 && server.form.baumodus)
                    {
                        if (server.form.verbesserung((Typ)befehl[3], (int)befehl[1], (int)befehl[2], (Spieler)befehl[4]))
                        {
                    ...
                    else if (server.voll && server.con_list[1].spieler == (Spieler)befehl[4] && server.con_list[1].geld > 0 && server.form.baumodus)
                    {
                        if (server.form.verbesserung((Typ)befehl[3], (int)befehl[1], (int)befehl[2], (Spieler)befehl[4]))
                        {
                ...
                case Befehlstyp.verbessernStats:
                    if (server.voll && server.con_list[0].spieler == (Spieler)befehl[4] && server.con_list[0].geld > 0 && server.form.baumodus)
                    {
                        if (server.form.verbesserungStats((Typ)befehl[3], (int)befehl[1], (int)befehl[2], (Spieler)befehl[4]))
                        {
                            server.con_list[0].geld--;
                            server.schreiben(befehl);
                        }
                ...
                case Befehlstyp.turmDrehen:
                    ...
                    {
                        if (server.form.karteStatisch.karteS[(int)befehl[1], (int)befehl[2]] != null)
                        {
                            server.form.karteStatisch.karteS[(int)befehl[1], (int)befehl[2]].turmD.ausrichten(vektorX, vektorY);
                            server.form.karteStatisch.karteS[(int)befehl[1], (int)befehl[2]].turmD.feuerbefehl = true;
                            server.schreiben(befehl);
                        }
                    ...
                    {
                        if (server.form.karteStatisch.karteS[feldgroesse * 2 - ((int)befehl[1]) - 1, (int)befehl[2]] != null)
                        {
                            server.form.karteStatisch.karteS[feldgroesse * 2 - ((int)befehl[1]) - 1, ((int)befehl[2])].turmD.ausrichten(vektorX * -1, vektorY);
                            server.form.karteStatisch.karteS[feldgroesse * 2 - ((int)befehl[1]) - 1, ((int)befehl[2])].turmD.feuerbefehl = true;
                            server.schreiben(befehl);
                        }
                    }
                    break;
                case Befehlstyp.bezierAusrichten:
                    ...
                    {
                        if (server.form.karteStatisch.karteS[P1.X / 30, P1.Y / 30] != null)
                        {
                            server.form.karteStatisch.karteS[P1.X / 30, P1.Y / 30].turmD.P1 = P1;
                            server.form.karteStatisch.karteS[P1.X / 30, P1.Y / 30].turmD.P2 = P2;
                            server.form.karteStatisch.karteS[P1.X / 30, P1.Y / 30].turmD.P3 = P3;
                            server.form.karteStatisch.karteS[P1.X / 30, P1.Y / 30].turmD.P4 = P4;
                            server.form.karteStatisch.karteS[P1.X / 30, P1.Y / 30].turmD.feuerbefehl = true;
                    ...
                    {
                        if (server.form.karteStatisch.karteS[feldgroesse * 2 - P1.X / 30 - 1, P1.Y / 30] != null)
                        {
                            server.form.karteStatisch.karteS[feldgroesse * 2 - P1.X / 30 - 1, P1.Y / 30].turmD.P1 = new Point(feldgroesse * 2 * blockgroesse - P1.X, P1.Y);
                            server.form.karteStatisch.karteS[feldgroesse * 2 - P1.X / 30 - 1, P1.Y / 30].turmD.P2 = new Point(feldgroesse * 2 * blockgroesse - P2.X, P2.Y);
                            server.form.karteStatisch.karteS[feldgroesse * 2 - P1.X / 30 - 1, P1.Y / 30].turmD.P3 = new Point(feldgroesse * 2 * blockgroesse - P3.X, P3.Y);
                            server.form.karteStatisch.karteS[feldgroesse * 2 - P1.X / 30 - 1, P1.Y / 30].turmD.P4 = new Point(feldgroesse * 2 * blockgroesse - P4.X, P4.Y);
                            server.form.karteStatisch.karteS[feldgroesse * 2 - P1.X / 30 - 1, P1.Y / 30].turmD.feuerbefehl = true;
